...
from utils.class_utils import LandmarkPoint, EyeLandmarks, LandmarkSet
...
class MediaPipeLandmarker:
    ...
    def __init__(
        self, 
        detector_path: Optional[str] = os.path.join(os.path.dirname(__file__), '../models/face_landmarker.task'), 
        tracker: bool = True, 
